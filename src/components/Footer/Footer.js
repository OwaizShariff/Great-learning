  ...
  return (
    <div>
        ...
        <div>
            ...
            <a  href="https://api.whatsapp.com/send?phone=+918618392962&text=Hello%21%21%21%20%20%20owaiz." target="_blank" rel="noreferrer"><img className='social-logo' src={WhatsappLogo} alt='InstaLogo' /></a>
        </div>
